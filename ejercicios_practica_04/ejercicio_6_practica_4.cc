/**
  ...
  * @brief  Escribir un programa en (C++), que calcule la distancia entre 2 puntos (A) y (B), en el espacio cartesiano de 3 dimensiones.
  ...
  * @see https://github.com/joselu-arr-rguez/ejercicios_practicas/blob/main/ejercicios_practica_04/ejercicio_6_practica_4.cc
