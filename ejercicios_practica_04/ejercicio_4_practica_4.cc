/**
  ...
  * @file ejercicio_4_practica_04.cc
  ...
  *        El programa solicitará al usuario, la calificación de cada uno de los tres alumnos, donde cada calificación, será un valor comprendido en
  
  *        el intervalo numérico entre (0.0) y (10.0).
  
  
  * @bug No hay "bugs" conocidos.
  
  * @see https://github.com/joselu-arr-rguez/ejercicios_practicas/blob/main/ejercicios_practica_04/ejercicio_4_practica_4.cc
