/**
  ...
  * @brief Escribir un programa en (C++), llamado "references.cc", que declare cuatro variables de diferentes tipos, y las inicialice, utilizando los 
  
  *        diferentes mecanismos, de inicialización de variables, que suministra el lenguaje. 
  ...
  * @see https://github.com/joselu-arr-rguez/ejercicios_practicas/blob/main/ejercicios_practica_5/references.cc
