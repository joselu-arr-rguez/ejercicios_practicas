/**
  ...
  * @brief Escribir un programa en (C++), llamado "modification", en el que se calcule, el "size" de los tipos básicos del lenguaje y las referencias
  ...
  * @see https://github.com/joselu-arr-rguez/ejercicios_practicas/blob/main/ejercicios_practica_5/modification.cc
