...
int main() {
   ...
   // We request that you enter us the number of bills and coins separately.
   ...
   total_result = result_one_cent + result_two_cents + result_five_cents + result_ten_cents + result_twenty_cents + result_fifty_cents + result_five_euros + result_ten_euros + result_twenty_euros + result_fifty_euros + result_one_hundred_euros + result_two_hundred_euros + result_five_hundred_euros;
  
  
   cout << "The total amount of money you have is: " << total_result << " €" << "\n";
