...
*        El programa solicitará al usuario, únicamente la cantidad de metros de longitud que tiene la carretera, mientras que el coste por metro, es

*        un valor conocido de (1624 €).


* @bug No hay "bugs" conocidos.

* @see https://github.com/joselu-arr-rguez/ejercicios_practicas/blob/main/ejercicios_practica_4/ejercicio_1_practica_4.cc
